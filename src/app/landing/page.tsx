    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="border-b border-slate-100 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/signup" className="bg-orange-500 text-white px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/30">{t.landing.tryFree}</Link>
          </div>
        </div>
      </nav>
      ...
      <section className="bg-slate-50 py-20">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-black text-slate-900 text-center mb-4">{t.landing.featuresTitle}</h2>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-black text-slate-900 mb-4">{t.landing.whyTitle}</h2>
      ...
      <section id="precios" className="bg-slate-50 py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-black text-slate-900 text-center mb-4">{t.landing.pricingTitle}</h2>
            ...
            {plans.map(plan => {
              ...
              return (
                <div key={plan} className={`rounded-2xl border-2 bg-white p-6 relative ${isPopular ? 'border-orange-300 ring-2 ring-orange-400/50' : 'border-slate-200'}`}>
                  ...
                  <p className="mt-2"><span className="text-4xl font-black text-slate-900">{price.monthly}</span><span className="text-sm text-slate-500"> EUR{t.landing.perMonth}</span></p>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-black text-slate-900 mb-4">{t.landing.ctaTitle}</h2>
